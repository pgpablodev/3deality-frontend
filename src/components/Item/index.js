...
const Item = () => {   
    ...
    const endpoint = 'https://pgpablo.helioho.st/api/articulo'
    ...
    useEffect( () => {
        ...
        const getProductosSugeridos = async () => {
            const response = await axios.get(`https://pgpablo.helioho.st/api/sugeridos`)
        ...
        <>
            <div className="container-fluid py-5 text-left">
                <div className="row px-xl-5">
                    <div className="col-lg-5 pb-5">                        
                        <img className="w-75" src={"https://pgpablo.helioho.st"+articulo.foto} alt="Image"></img>
                    </div>
            ...
            <div className="container-fluid py-5">
                ...
                <div className="row">
                    ...
                    ?
                    <>
                    <Product key={1} id={productos[0].id} nombre={productos[0].nombre} precio={Number(productos[0].precio)} foto={"https://pgpablo.helioho.st"+productos[0].foto} tam={4}/>
                    <Product key={2} id={productos[1].id} nombre={productos[1].nombre} precio={Number(productos[1].precio)} foto={"https://pgpablo.helioho.st"+productos[1].foto} tam={4}/>
                    <Product key={3} id={productos[2].id} nombre={productos[2].nombre} precio={Number(productos[2].precio)} foto={"https://pgpablo.helioho.st"+productos[2].foto} tam={4}/>
                    </>
                    :
                    <></>
                    }
